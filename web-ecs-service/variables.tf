...
variable "service_without_lb_count" {
  description = "Create or not service without load balancer"
  default     = 0
}
...
variable "capacity_provider" {
  description = "Name of the capacity provider. WARNING! YOU CAN'T USE COMPUTED VALUES (e.g., data.source.attr) (except variables)"
  default     = ""
}

variable "enabled" {
  description = "Create or not a service"
  default     = true
}
